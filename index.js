...
let icon = "assets/crunchyroll.png";
...
function loadPlugins(win) {
    injectCSS(win.webContents, path.join(__dirname, "crunchydesk.css"));
    // Load user CSS
...
function createMainWindow() {
    ...
    win.on("resize", () => {
        ...
        if (!isPiPEnabled) {
            ...
            config.plugins.getOptions("picture-in-picture")["saveSize"]
        ) {
...
app.once("browser-window-created", (event, win) => {
    ...
    win.webContents.on(
        ...
        (
            ...
            if (
                !(config.plugins.isEnabled("in-app-menu") && errorCode === -3)
            ) {
...
app.on("ready", () => {
    ...
    if (is.windows()) {
        ...
        const appID = "com.github.arjixwastaken.crunchydesk";
        ...
        if (
            ...
            try {
                ...
                const shortcutDetails =
                    electron.shell.readShortcutLink(shortcutPath); // throw error if doesn't exist yet
                if (
                ...
                electron.shell.writeShortcutLink(
                    ...
                    error === "needUpdate" ? "update" : "create",
                    {
                        ...
                        description:
                            "An unofficial desktop client for crunchyroll.",
...
function showUnresponsiveDialog(win, details) {
    ...
    electron.dialog
        .showMessageBox(win, {
            ...
            details:
                "We are sorry for the inconvenience! please choose what to do:",
