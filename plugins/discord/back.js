...
module.exports = (
    win,
    { activityTimoutEnabled, activityTimoutTime, watchAlong, hideDurationLeft }
) => {
    window = win;
    ...
    updateActivity = (songInfo) => {
        ...
        const activityInfo = {
            type: 3, // Watching, addressed in https://github.com/discordjs/RPC/pull/149
            details: songInfo.title,
            state: songInfo.artist,
            largeImageKey: songInfo.imageSrc,
            largeImageText: songInfo.album,
            buttons: watch
                ? [{ label: "Watch Along", url: songInfo.url }]
                : undefined,
        };
